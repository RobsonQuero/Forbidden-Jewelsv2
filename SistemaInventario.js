...
function SistemaInventario (canvas,player){
	...
	//Trilha Sonora
	trilha_inventario = new Audio();
	trilha_inventario.src = "musicas/intro.mp3";
	trilha_inventario.volume = 0.5;
	...
	this.returnState = function(){
		if(gameState == thisScene){
			...
			trilha_inventario.load();
			trilha_inventario.pause();
			return nextScene;
		}
	}
